...
path = '../fake_detect/resnet50_phase_Normalized'
try :
    shutil.rmtree(path)
except:
    pass
...
total_dataset = FakeDataset(root_dir='/home/daehyeon/hdd/fft_pro/', normalize = True)

total_size = len(total_dataset)
train_size = int(np.ceil(total_size*0.98))
test_size = int(np.floor(total_size*0.02))
print(test_size)
...
# ---------------------- #
            ...
            if (epoch * len(train_loader) + i)%3600 ==3599:
                scheduler.step()
