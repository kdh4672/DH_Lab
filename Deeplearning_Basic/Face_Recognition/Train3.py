...
classes = classes  = os.listdir('/home/daehyeon/hdd/High_Resolution_Files')+os.listdir('/home/daehyeon/hdd/Total_Face')
...
#load data
total_dataset=CustomDataset(root_dir='/home/daehyeon/hdd/403_High', transform = transforms)
