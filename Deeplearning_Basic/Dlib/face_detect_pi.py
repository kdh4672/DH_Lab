...
path = '../fake_detect/resnet50_phase_focal'
try :
    shutil.rmtree(path)
except:
    pass
...
total_dataset = FakeDataset(root_dir='/home/daehyeon/hdd/numpy_files', transform = None)
...
# ---------------------- #
            ...
            if (epoch * len(train_loader) + i)%6250 ==6249:
                scheduler.step()
